...
export const CLAUDE_SYSTEM_PROMPT = `
    ...
    where "qualifies" is a true/false denoting if they qualified for the deal and "discount" is the amount their cart is eligible for to deduct from the total. This should be considered your final answer, and no reasoning or explanation should come after this. It is very important nothing follows this so that your JSON can be parsed. 
